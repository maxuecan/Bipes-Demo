...
Blockly.Msg["EXTENSION_CAR_INIT"] = "电机与舵机初始化， 并设置默认转速";
Blockly.Msg["EXTENSION_CAR_COLUMN_POWER"] = "麦轮车 %1 ，动力 %2";
Blockly.Msg["EXTENSION_CAR_COLUMN_POWER_TIME"] = "麦轮车 %1 ，动力 %2 ，持续 %3 毫秒";
Blockly.Msg["EXTENSION_CAR_DRIVING_POWER"] = "麦轮车行驶动力：左前轮 %1，右前轮 %2，左后轮 %3，右后轮 %4";
Blockly.Msg["EXTENSION_CAR_UNIFORM_DRIVING_POWER"] = "麦轮车行驶动力：左前轮 %1，右前轮 %2，左后轮 %3，右后轮 %4，持续 %5毫秒";
Blockly.Msg["EXTENSION_CAR_ROW_POWER"] = "麦轮车 %1，动力 %2";
Blockly.Msg["EXTENSION_CAR_ROW_POWER_TIME"] = "麦轮车 %1，动力 %2，持续 %3毫秒";
Blockly.Msg["EXTENSION_CAR_CAMERA_ANGLE"] = "麦轮车摄像头 %1，角度 %2";
Blockly.Msg["EXTENSION_CAR_STOP"] = "停止所有轮子转动";
Blockly.Msg["MECHANICAL_ARM_INITIALIZATION"] = "初始化机械臂";
Blockly.Msg["MECHANICAL_ARM_RESET"] = "机械臂复位";
Blockly.Msg["MECHANICAL_ARM_SERVO_PULSE"] = "获取舵机 %1 的脉冲值";
Blockly.Msg["MECHANICAL_ARM_COORDINATES"] = "获取末端执行器坐标 %1 的值";
Blockly.Msg["MECHANICAL_ARM_MOVE_COORDINATES"] = "移动到空间位置: x[ %1 ]，y[ %2 ]，z[ %3 ]，运行时间 %4 毫秒";
Blockly.Msg["MECHANICAL_ARM_UNIFORM_MOVE_COORDINATES"] = "沿 %1 轴移动距离 %2 ，运动时间 %3 毫秒";
Blockly.Msg["MECHANICAL_ARM_MOVE_PHOTO"] = "移动到图像位置：x[ %1 ]，y[ %2 ]，z[ %3 ]，图像大小宽 %4 ，高 %5";
Blockly.Msg["MECHANICAL_ARM_SERVO_PARAMETERS"] = "设置舵机 %1 的脉冲为 %2， 运行 %3 毫秒，限位 %4";
Blockly.Msg["MECHANICAL_ARM_AIR_PUMP"] = "气泵 %1";
Blockly.Msg["MECHANICAL_ARM_AIR_PUMP_ANGLE"] = "气泵旋转角度 %1";
Blockly.Msg["MECHANICAL_ARM_GRAP"] = "夹爪 %1 角度，%2 ，运动 %3 毫秒";
Blockly.Msg["CONTROL_FOREVER"] = "重复执行";
Blockly.Msg["CONTROL_REPEAT_UNTIL"] = "重复执行直到 %1";
Blockly.Msg["CONTROL_WAIT_UNTIL"] = "等待 %1 秒";
Blockly.Msg["MATH_NEW_RANDOM_FLOAT"] = "从 %1 到 %2 范围内的随机小数";
Blockly.Msg["MATH_TYPE_CHANGE"] = "将 %1 转为 %2";
Blockly.Msg["MATH_DECIMAL_CONVERSION"] = "把 %1 进制 %2 转换为 %3 进制";
Blockly.Msg["MATH_HALF_ADJUST"] = "%1 四舍五入 保留 %2 位";
Blockly.Msg["TEXT_TO_CHAR"] = "转ASCII字符 %1";
Blockly.Msg["TEXT_TO_NUMBER"] = "转ASCII数值 %1";
Blockly.Msg["TEXT_TO_STRING"] = "转字符串 %1";
Blockly.Msg["TEXT_STR_CONCAT"] = " %1 连接 %2";
Blockly.Msg["TEXT_STR_DIAGNOSIS"] = "%1 %2 %3";
Blockly.Msg["TEXT_STR_RES_CODE"] = "%1 %2 字符串 %3";
Blockly.Msg["TEXT_STR_REPLACE"] = "%1 替换 %2 为 %3";
Blockly.Msg["TEXT_STR_SPLIT"] = "%1 按照 %2 划分";
Blockly.Msg["LISTS_SERACH_VALUE"] = "%1 获取 值 %2 的 %3";
Blockly.Msg["LISTS_PUSH_END"] = "在列表中%1 %2 一项 %3 到末尾";
Blockly.Msg["LISTS_DEL"] = "在列表中%1 删除制定项 %2 %3";
Blockly.Msg["LISTS_POP"] = "从列表中%1 删除并获取 第 %2 项";
Blockly.Msg["LISTS_TO_LIST"] = "将 %1 转化为列表";
Blockly.Msg["ELEMENT"] = "元素";
Blockly.Msg["TUPLE_ELEMENT"] = "元素";
Blockly.Msg["TUPLE_CREATE_WITH_CONTAINER"] = "元组";
Blockly.Msg["TUPLE_CREATE_EMPTY_TITLE"] = "创建空元组";
Blockly.Msg["TUPLE_CREATE_WITH_INPUT_WITH"] = "创建元组，内容：";
Blockly.Msg["TUPLE_INDEXOF"] = "%1 的第 %2 项";
Blockly.Msg["TUPLE_SLICE"] = "%1 获取 第 %2 项 到第 %3 项";
Blockly.Msg["TUPLE_RANDOM_ITEM"] = "%1 获取 随机一项";
Blockly.Msg["TUPLE_LENGTH"] = "%1 获取长度";
Blockly.Msg["TUPLE_MAX_VALUE"] = "%1 获取 %2";
Blockly.Msg["TUPLE_SERACH_VALUE"] = "%1 获取 值 %2 的 %3";
Blockly.Msg["TUPLE_DELETE"] = "%1 删除元组";
Blockly.Msg["TUPLE_CONCAT"] = "%1 连接 %2";
Blockly.Msg["TUPLE_TO_TUPLE"] = "转元组 %1";
Blockly.Msg["DICTS_ELEMENT"] = "条目";
Blockly.Msg["DICTS_CREATE_WITH_CONTAINER"] = "字典";
Blockly.Msg["DICTS_CREATE_EMPTY_TITLE"] = "创建空字典";
Blockly.Msg["DICTS_CREATE_WITH_INPUT_WITH"] = "创建字典，内容：";
Blockly.Msg["DICTS_KEYS"] = "%1 获取所有键";
Blockly.Msg["DICTS_GET"] = "%1 获取键 %2 对应值";
Blockly.Msg["DICTS_GET_DEFAULT"] = "%1 获取键 %2 对应值 默认值为 %3";
Blockly.Msg["DICTS_ADD_OR_CHANGE"] = "%1 中添加或修改条目 键 %2 对应值 %3";
Blockly.Msg["DICTS_DELETE"] = "%1 中删除条目 键 %2 及对应值";
Blockly.Msg["DICTS_POP"] = "%1 获取并删除字典中键 %2 对应值";
Blockly.Msg["DICTS_SETDEFAULT"] = "%1 设置 键 %2 默认值为 %3";
Blockly.Msg["DICTS_CLEAR"] = "%1 清空字典中所有条目";
Blockly.Msg["DICTS_VALUES"] = "%1 获取所有键对应的值";
Blockly.Msg["DICTS_LENGTH"] = "%1 获取长度";
Blockly.Msg["DICTS_DELDICT"] = "%1 删除字典";
Blockly.Msg["DICTS_TODICT"] = "转字典 %1";
Blockly.Msg["DICTS_TO_JSON"] = "%1 json 序列化";
Blockly.Msg["JSON_TO_DICTS"] = "%1 json 反序列化";
Blockly.Msg["SET_CREATE_WITH_CONTAINER"] = "集合";
Blockly.Msg["SET_ELEMENT"] = "元素";
Blockly.Msg["SET_CREATE_EMPTY_TITLE"] = "创建空集合";
Blockly.Msg["SET_CREATE_WITH_INPUT_WITH"] = "创建集合，内容：";
Blockly.Msg["SET_LEN"] = "%1 获取长度";
Blockly.Msg["SET_POP"] = "%1 获取并删除集合中随机一项";
Blockly.Msg["SET_OPERATE"] = "%1 与集合 %2 取 %3";
Blockly.Msg["SET_OPERATE_UPDATE"] = "%1 与集合 %2 取 %3并更新";
Blockly.Msg["SET_ADD_DISCARD"] = "%1 %2 元素 %3";
Blockly.Msg["SET_UPDATE"] = "%1 拆分增加 列表/字符串 %2";
Blockly.Msg["SET_SUB"] = "%1 是否是集合 %2 的 %3";
Blockly.Msg["SET_TOSET"] = "转集合 %1";
Blockly.Msg["TURTLE_CREATE"] = "创建海龟";
Blockly.Msg["TURTLE_MOVE"] = "%1 向 %2 移动 %3";
Blockly.Msg["TURTLE_ROTATE"] = "%1 向 %2 旋转 %3";
Blockly.Msg["TURTLE_MOVE_XY"] = "%1 移动 X %2 Y %3";
Blockly.Msg["TURTLE_SET_POSITION"] = "%1 %2 坐标 设置为 %3";
Blockly.Msg["TURTLE_DRAW_CIRCLE"] = "%1 绘制 圆，半径%2 夹角 %3 内切 %4";
Blockly.Msg["TURTLE_DRAW_POLYGON"] = "%1 绘制 %2 边形，外接圆 半径 %3";
Blockly.Msg["TURTLE_DRAW_POINT"] = "%1 绘制 点，直径 %2";
Blockly.Msg["TURTLE_WRITE"] = "%1 书写 %2";
Blockly.Msg["TURTLE_SET_HEADING"] = "%1 面向 %2 度";
Blockly.Msg["TURTLE_PENDOWN"] = "%1 %2";
Blockly.Msg["TURTLE_SET_PENSIZE"] = "设置%1 粗细 %2";
Blockly.Msg["TURTLE_SET_SPEED"] = "设置%1 速度 %2";
Blockly.Msg["TURTLE_GET_POSITION"] = "%1 %2 的坐标";
Blockly.Msg["TURTLE_SHOW_HIDE"] = "%2 %1 ";
Blockly.Msg["TURTLE_CLEAR"] = "清空 %1 ";
Blockly.Msg["TURTLE_STOP"] = "%1 停止运行";
Blockly.Msg["TURTLE_SET_BGCOLOR"] = "设置 背景 颜色 %1";
Blockly.Msg["TURTLE_SET_PENCOLOR"] = "设置 %1  颜色 %2";
Blockly.Msg["TURTLE_SET_FILLCOLOR"] = "设置 %1 填充 %2";
Blockly.Msg["TURTLE_SET_COLORMODE"] = "设置 %1 颜色模式 %2";
Blockly.Msg["TURTLE_SET_FILL"] = "设置 %1 填充 %2";
Blockly.Msg["TURTLE_SET_COLOR"] = "设置 %1 颜色值 %2";
Blockly.Msg["CONTROLS_COMPARE_CONTINOUS"] = "%1 %2 %3 %4 %5";
Blockly.Msg["MOTION_MOVE"] = "前进";
Blockly.Msg["MOTION_ROTATE"] = "%1";
Blockly.Msg["MOTION_HIT"] = "攻击";
Blockly.Msg["SERIAL_INIT"] = "初始化 %1 RX# %2 TX# %3 波特率 %4";
Blockly.Msg["SERIAL_PRINT"] = "Serial %1 打印 %2";
Blockly.Msg["SERIAL_PRINTLN"] = "Serial %1 打印 （自动换行） %2";
Blockly.Msg["SERIAL_PRINTLN_RADIX"] = "Serial %1 打印 （自动换行） %2 %3";
Blockly.Msg["SERIAL_SEND_MSG"] = "Serial %1 发送数据 %2 到其它MP设备 重复 %3";
Blockly.Msg["SERIAL_OUTPUT"] = "Serial %1 原始输出(字节) %2";
Blockly.Msg["SERIAL_ANY"] = "Serial %1 有数据可读吗？";
Blockly.Msg["SERIAL_READ"] = "Serial %1 读取字符串";
Blockly.Msg["SERIAL_READLINE"] = "Serail %1 读取一行";
Blockly.Msg["SERIAL_READ_OTHERS"] = "Serial %1 读取其它MP设备数据";
Blockly.Msg["EXTENSION_CAR_CAMERA_ANGLES"] = "%1";
Blockly.Msg["FILE_IS_WRITABLE"] = "文件%1是否可写";
Blockly.Msg["FILE_GET_NAME"] = "获取%1的文件名";
Blockly.Msg["FILE_CLOSE"] = "关闭文件%1";
Blockly.Msg["FILE_LISTDIR"] = "列出所有文件";
Blockly.Msg["FILE_GETCWD"] = "获取当前工作目录";
Blockly.Msg["FILE_CHDIR"] = "改变当前工作目录为%1";
Blockly.Msg["FILE_MKDIR"] = "根据目录%1创建%2";
Blockly.Msg["FILE_REMOVE"] = "%1 %2";
Blockly.Msg["FILE_RENAME"] = "重命名文件%1为%2";
Blockly.Msg["FILE_TELL"] = "返回文件%1当前读取的位置";
Blockly.Msg["FILE_SEEK"] = "设置文件%1当前读取位置为%2偏移%3字符";
Blockly.Msg["IO_RATE"] = "%1";
Blockly.Msg["IO_INIT_PIN"] = "初始化 %1 为 %2 管脚 # %3";
Blockly.Msg["IO_PINOUT_SET"] = "数字输出 %1 设为 %2";
Blockly.Msg["IO_PININ_SET"] = "获取 数字输入 %1 的值";
Blockly.Msg["IO_INIT_PIN_IN"] = "初始化 %1 为 模拟输入 管脚 # %2";
Blockly.Msg["IO_IN_VOLTAGE"] = "模拟输入 %1 参考电压设为 %2";
Blockly.Msg["IO_IN_GET"] = "获取 数字输入 %1 的值";
Blockly.Msg["IO_INIT_PWMOUT_SET"] = "初始化 %1 为 PWM模拟输出 管脚 # %2";
Blockly.Msg["IO_PWMOUT_SET"] = "设置 PWM模拟输出 %1 的占空比为 %2";
Blockly.Msg["IO_PWMOUT_RATE_SET"] = "PWM模拟输出 %1 频率设为 %2";
Blockly.Msg["IO_INIT_TOUCH_SENSOR_SET"] = "初始化 %1 为 触摸传感器 管脚 # %2";
Blockly.Msg["IO_TOUCH_SENSOR_GET"] = "获取 触摸传感器 %1 的值";
Blockly.Msg["IO_STOP"] = "硬件中断 管脚 # %1 模式 %2 执行 %3";
Blockly.Msg["OLED_CLEAR"] = "清空屏幕";
Blockly.Msg["OLED_SHOW"] = "显示屏幕";
Blockly.Msg["OLED_TEXT8"] = "绘制8x8文本 %1 x轴 %2 y轴 %3";
Blockly.Msg["OLED_TEXT16"] = "绘制16x16文本 %1 x轴 %2 y轴 %3";
Blockly.Msg["OLED_TEXT_SCROLL"] = "绘制滚动文本 %1 y轴 %2";
